...
public class Iron_Furnace extends BlockBase {
    ...
    public Iron_Furnace(String name, Material material,boolean isBurning){
        super(name, material);
...
/*
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (!keepInventory){
            TileEntity tileentity = worldIn.getTileEntity(pos);
            if (tileentity instanceof Tile_Entity_Iron_Furnace){
                InventoryHelper.dropInventoryItems(worldIn, pos, (Tile_Entity_Iron_Furnace) tileentity);
