...
public class ContainerIronFurnace extends Container {
    ...
    public ContainerIronFurnace(InventoryPlayer player, Tile_Entity_Iron_Furnace tileentity)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if(slot != null && slot.getHasStack())
        {
            ...
            else if(index != 2 && index != 1 && index != 0)
            {
                ...
                if(!Iron_Furnace_Recipes.getInstance().getIronFurnaceResult(stack1, slot1.getStack()).isEmpty())
                {
                    if(!this.mergeItemStack(stack1, 0, 2, false))
                    {
                        return ItemStack.EMPTY;
                    }
                    else if(Tile_Entity_Iron_Furnace.isItemFuel(stack1))
                    {
